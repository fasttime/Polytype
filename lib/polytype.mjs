// Polytype 0.1.0 – https://github.com/fasttime/Polytype
...
(obj, asNewArray) =>
{
    ...
    else
    {
        ...
        prototypes = prototype !== null ? [prototype] : asNewArray ? [] : EMPTY_ARRAY;
    }
    return prototypes;
};
...
obj =>
{
    if (isCallable(obj))
    {
        ...
        try
        {
            // A standalone class expression would be stripped off by a minifier.
            // The negation preserves the class expression along with its side effects.
            const trueValue =
