...
(global =>
{
    ...
    function createConstructorProxy(typeSet, prototypeSet)
    {
        ...
        {
            class: describeDataProperty(superTypeCall),
    ...
    const createGetConstructorName =
        typeSet => () => `(${[...typeSet].map(type => String(type.name))})`;
    ...
    function createSuperPrototypeCall(prototypeSet)
    {
    ...
    function createSuperTypeCall(typeSet)
    {
        const superTypeCall =
        {
            class(type)
