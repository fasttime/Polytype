...
- [Caveats](#caveats)
  ...
  * [Homonymous protected instance members](#homonymous-protected-instance-members)
...
```html
<script src="https://cdn.statically.io/gh/fasttime/Polytype/0.2.0/lib/polytype.min.js"></script>
```
...
```js
import { classes } from "https://cdn.statically.io/gh/fasttime/Polytype/0.2.0/lib/polytype.min.mjs";
```
...
is currently not possible to disambiguate between protected instance members having the same name or
property key in different base classes.
...
### Homonymous protected instance members
...
[polytype.min.js]:
https://raw.githubusercontent.com/fasttime/Polytype/0.2.0/lib/polytype.min.js
[Why Use for...in?]:
