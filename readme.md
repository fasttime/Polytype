...
Just download
[polytype.min.js](https://cdn.jsdelivr.net/npm/polytype@0.9.4/lib/polytype.min.js) and include
...
```html
<script src="https://cdn.jsdelivr.net/npm/polytype@0.9.4/lib/polytype.min.js"></script>
```
...
```js
import { classes } from "https://cdn.jsdelivr.net/npm/polytype@0.9.4/lib/polytype.min.mjs";
```
...
[ColoredCircle.ts](https://github.com/fasttime/Polytype/blob/0.9.4/example/ColoredCircle.ts)
