...
* Works in Node.js and in all new browsers
* Full TypeScript support
* Zero dependencies
* Access to all base class features
  * constructors
  * methods, getters and setters, [class fields][Class fields] – both static and nonstatic
...
Just download
[polytype.min.js](https://cdn.jsdelivr.net/npm/polytype@0.14.1/lib/polytype.min.js) and include
...
```html
<script src="https://cdn.jsdelivr.net/npm/polytype@0.14.1/lib/polytype.min.js"></script>
```
...
```js
import { classes } from "https://cdn.jsdelivr.net/npm/polytype@0.14.1/lib/polytype.min.mjs";
```
...
[ColoredCircle.ts](https://github.com/fasttime/Polytype/blob/0.14.1/example/ColoredCircle.ts)
...
The minimum supported TypeScript version is 4.2.
